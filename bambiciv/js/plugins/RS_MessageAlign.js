 ...
 * @author biud436, modified mildly by MTM101.
 * @help
 * =============================================================================
 * NOTES FROM MTM: This plugin was modified so it only works on scrolling text and nothing else, because we only needed this plugin for the credits and it was breaking a lot of other shit.
 * -----------------------------------------------------------------------------
 * Usage
 * -----------------------------------------------------------------------------
...
(function () {
    ...
    Window_Base.prototype.drawTextExWithAlignment = function (text, x, y) {
        if (text) {
            this.resetFontSettings();
            const textState = { index: 0, x, y, left: x };
            textState.text = this.convertEscapeCharacters(text);
	...
	Window_ScrollText.prototype.drawTextEx = Window_ScrollText.prototype.drawTextExWithAlignment;
