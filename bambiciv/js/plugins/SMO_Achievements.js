/*:
* @plugindesc v1.04 - Adds an achievements mechanic.
* @author SMO
*
...
* @param Secret Description
* @type note
* @desc The achievement body when this achievement is secret. (Bambi Civ added Feature!)
* Maximum of 3 lines.
* @default ""
*
* @param Pop Up Desc
...
SMO.AM.resetDynamicData = function() {
	SMO.AM.DataDynamic.achievs = $dataAchievements.map(a => ({ state:a.visibility == 'visible' ? 0 : -1, date:0 }));
...
Object.defineProperty(Achievement_Data.prototype, 'description', {
	get: function() {
		return this.isSecret() ? ((this._secretDescription == "") ? SMO.AM.secretDescription : this._secretDescription) : this._description;
	},
	set: function(value) {
...
Achievement_Data.prototype.initialize = function(id, data) {
	...
	this._secretDescription = $dataAchievements ? data['Secret Description'] : SMO.AM.parse(data['Secret Description']);
	this._secretDescription = (this._secretDescription == null) ? "" : this._secretDescription
...
Window_Trophies.prototype.initValues = function() {
	...
	this._trophy_w = 125//Math.floor((this._maxWidth / 2 - this._gap * (this._maxCols + 1)) / (this._maxCols - 1));
	this._trophy_h = 100//Math.floor((this._big_trophy.height - this._gap * (this._maxLines - 1)) / this._maxLines);
	this._x_fix = this.fixToTrophyX();
	this._y_fix = this.fixToTrophyY() + 160;
};
