...
//yanfly engine i love you but i have to keep fixing you why
...
Window_Base.prototype.convertExtraEscapeCharacters = function(text) {
  text = Window_Base.prototype.convertPlaytime(text);
  text = Window_Base.prototype.convertMapName(text);
  text = Window_Base.prototype.convertEnemyName(text);
  text = Yanfly.EMP1.Window_Base_convertExtraEscapeCharacters.call(this, text);
  text = Window_Base.prototype.convertDigitGrouping(text);
  return text;
};
